...
//'**********Delete Booking ************
if ($_GET["type"] == "del") {
  $dbquery_del  = "UPDATE purchase_order_item SET deleteitem='1' where id=".$catid;
...
while($row = $result->fetch_assoc()) {
  ...
  <input type="text" value="<?php echo $row["name"]; ?>" name="" readonly>
          ...
          <td><a href="modifypo.php?id=<?=$row["poiid"]?>&type=del" class="remove-btn" onClick="javascript:return fundel()">X</a></td>
        </tr>
          <?php
